...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      ref={sectionRef}
      className="snap-section section-contact bg-black-section torn-edge-top torn-black flex items-center justify-center px-6 md:px-16 py-20"
    >
      <div className="max-w-3xl w-full text-center">
        <div className="section-content">
          ...
          <h2 className="text-5xl md:text-7xl lg:text-[6.5rem] font-black uppercase leading-[0.9] tracking-tight text-cream">
            Code With A
          </h2>
          <h2 className="text-5xl md:text-7xl lg:text-[6.5rem] font-black uppercase leading-[0.9] tracking-tight text-accent mt-2">
            Clean Logic
          </h2>
          <p className="mt-8 text-cream/50 text-base md:text-lg max-w-md mx-auto leading-relaxed">
            Создаю быстрые, масштабируемые и красивые веб-приложения с вниманием к деталям.
          </p>
        </div>

        <div className="section-content delay-200 mt-10 flex flex-wrap justify-center gap-4">
          <a
        ...
        <div className="mt-16 pt-8 border-t border-cream/10">
          <p className="text-xs text-cream/40 uppercase tracking-wider">
            &copy; 2026 Raul. All rights reserved.
          </p>
        </div>
      </div>
    </section>
